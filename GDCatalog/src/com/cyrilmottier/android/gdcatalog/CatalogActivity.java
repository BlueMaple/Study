...
public class CatalogActivity extends GDListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.add(createTextItem(R.string.dynamic_item_label, DynamicListActivity.class));
        adapter.add(createTextItem(R.string.sql_tool_label, SQLiteCreationActivity.class));
